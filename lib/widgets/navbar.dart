  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.only(
        top: dWidth > 950 ? dWidth * 0.01 : dWidth * 0.05,
        bottom: dWidth * 0.02,
        right: dWidth * 0.01,
        left: dWidth * 0.02,
      ),
      child: Row(
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              Container(
                width: dWidth > 850 ? dWidth * 0.03 : dWidth * 0.06,
                height: dWidth > 850 ? dWidth * 0.03 : dWidth * 0.06,
                ...
                child: Center(
                  child: Text("K",
                      style: TextStyle(
                          fontSize:
                              dWidth > 850 ? dWidth * 0.02 : dWidth * 0.04,
                          color: Colors.white)),
                ),
              ),
              SizedBox(
